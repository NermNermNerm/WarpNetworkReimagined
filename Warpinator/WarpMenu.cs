...
class WarpMenu : IClickableMenu
{
	...
	public WarpMenu(ModEntry mod, int x = 0, int y = 0, int width = 0, int height = 0)
        : base(x, y, width, height, true)
    {
        this.mod = mod;

        this.destinations = WarpDestination.GetDestinationsForMenu();
