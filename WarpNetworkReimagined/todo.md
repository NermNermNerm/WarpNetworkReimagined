...
- [x] An NPC will be needed to enable the above dialog.
...
- [x] Long lines are a problem in the events.
...
- [x] Set up the troll booth and store.
- [x] Add a totem-wallet chip
...
- [x] Add a really expensive item that makes it like there's an obilisk at the farm.
